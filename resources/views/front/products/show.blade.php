                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <h3 class="price">{{ Currency::format($product->price, 'USD') }}@if($product->compare_price)<span>{{ Currency::format($product->compare_price, 'USD') }}</span>@endif</h3>
                            <p class="info-text">{{ $product->description }}</p>
                            <p class="info-text">{{ $product->quantity }}</p>
